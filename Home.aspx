...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
       ...
       <br />
        ...
        <span class="k-button k-solid k-success" style="color: #ffffff; background-color: #E846CD ; border: medium solid #FF80AA "><a class ="btn" href="Gallery.aspx">Gallery</a></span>
        <br />
             <br />
        <div class="container">
